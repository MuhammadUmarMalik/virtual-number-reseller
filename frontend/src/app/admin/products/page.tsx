...
import { deleteProduct, getAdminProducts, syncProductStock, updateProduct } from "@/services/admin.service";
...
export default function AdminProductsPage() {
  ...
  const deleteMutation = useMutation({
    ...
    onError: (error) => {
      toast.error(error instanceof ApiError ? error.message : "Unable to delete product");
    },
  });
  ...
  const syncMutation = useMutation({
    ...
    onError: (error) => {
      toast.error(error instanceof ApiError ? error.message : "Unable to sync stock");
    },
  });
